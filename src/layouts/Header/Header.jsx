  ...
  return (
    ...
    <header className="navbar d-flex align-items-center">
      <div className="d-flex align-items-center gap section-logo">
       ...
       <div className={searchMenu ? 'searchMenuStyle active ': 'searchMenuStyle hide'}>
        <InputGroup>
      ...
      <div className="d-flex gap-2">
        ...
        <Button variant="light" className="d-flex d-lg-none align-items-center" onClick={() => setSearchMenu(!searchMenu)}>
        ...
        <nav className={`links d-lg-none gap-1 mobile-menu ${menuShow ? ' active ' : ''}`}>
              <LinksNav menuShow={menuShow} setMenuShow={setMenuShow}/>
        </nav>
